...
public class StateCensusAnalyserTest {
    public static final String STATE_CODE_CSV = "C:\\Users\\home\\Desktop\\intelij\\MyStateCensusAnalyser\\src\\main\\resources\\StateCode.csv";
    public static final String STATE_CENSUS_DATA_CSV = "C:\\Users\\home\\Desktop\\intelij\\MyStateCensusAnalyser\\src\\main\\resources\\StateCensusData.csv";
    ...
    public void GivenTheStateCensusCsvFile_WhenCorrect_ButFileExtensionIncorrect_ShouldThrowCensusAnalyserException() throws IOException {
        try {
            int count = StateCensusAnalyser.openCsvBuilder(STATE_CODE_CSV, StateCensus.class);
        } catch (CensusAnalyserException e) {
            e.printStackTrace();
